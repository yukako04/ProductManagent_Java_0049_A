...
public class ProductEdit {
	...
	//入力ファイル
	File file_name = new File("C:\\pleiades\\2022-06\\workspace\\ProductManagent_Java_0049_A\\products_0049_A.csv .csv");
	...
	public void dataLoad() {
		try {
			String line;
			br = new BufferedReader(new InputStreamReader(new FileInputStream(file_name), "Shift_JIS"));//"UTF-8"
	...
	public void updata() {
		...
		if (text1.equals("Y")) {
			...
			try {
				// 出力ファイルの作成
				BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file_name, false), "Shift_JIS"));
